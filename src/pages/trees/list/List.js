                  ...
                  <div className="card-body p-0">
                    <Table
                      data={store.list.map((listData, index) => ({
                        scanId: listData.scanId,
                        date: utcToLocalTime(listData.date),
                        zone: listData.zone ? listData.zone.name : "",
                        sector: listData.sector ? listData.sector.name : "",
