...
function PurchaseList() {
  ...
  const pageName = "Purchases";
  const routeStart = "/purchase";
  const breadCrumbs = [
    {
      name: "Dashboard",
      link: "/dashboard",
                  ...
                  <div className="card-body p-0">
                    <Table
                      data={store.list.map((listData, index) => ({
                        purchaseDate: utcToLocalTime(listData.purchaseDate),
                        material: listData.rawMaterial.name,
                        price: listData.purchasePrice,
                        unit: listData.unitsPurchased,
